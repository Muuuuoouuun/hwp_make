...
Latest strict audit: [body text scope and baseline development](audits/2026-09-22/body-scope-baseline-progress.md). Weighted harsh 36-page average improves 86.47 → 87.31 (86.55 Korean, 88.23 math, 87.45 English): 20 improved, 6 regressed, 10 unchanged scores. Body comparison now excludes running controls; Korean 27,028/27,028 characters match and four header/footer relocation API cases return 422 despite perfect writer stats. First-line equation space and dominant-prose baseline fixes reduce 22 later math column-start vertical errors from 3.0169px to 0.003541px. English ten-line body remains one paragraph through +790-character edit/re-save. Full regression: 101 PASS, 11 SKIP, 1 FAIL; 33 primary packages valid. Real Korean structured and math coordinate API/downloads pass. The 93-point goal is not achieved; this is not a five-field overall score.

Current P0 order: (1) fix math Q27 graph-label duplication and ownership: labels already visible in the source-figure crop are also emitted as standalone native paragraphs, displacing the graph and its labels; preserve genuine editable content without prose/math image overlays; (2) improve source fonts, equation spacing and all-page fidelity, including the six current score regressions; (3) resolve math page 11 diagram y +12.7757px, page 9 Q22 marker x +0.4449px, and generic first-page masthead baseline +4.081255px against 0.1px; (4) footer/first-page automatic number, endnote import ownership, full subject re-evaluation and direct Hancom editing. Math page 4/7 diagram coordinates and all 22 checked vertical column-start baselines now pass 0.1px. Header/body comparison is fixed. The earlier font replacement experiments remain rejected; no source font fix is claimed.
