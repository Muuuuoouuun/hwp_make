...
> 최신 국어·수학·영어 재평가는 [격자 안내문 문단 편집과 엄격 재평가](audits/2026-09-23/grid-frame-paragraphs-progress.md)를 따릅니다. 36쪽 엄격 배치 평균은 같은 환경 기준 **87.04 → 87.06**, 최저 **72.85**이며 **93점 미달**입니다. 영어 27번의 글머리표 5개를 각각 편집 가능한 문단으로 만들고 수정·재저장을 검증했습니다. 앞선 [그래프 표기 복원](audits/2026-09-23/native-graph-annotations-progress.md)도 유지됩니다. 전체 회귀는 **103 통과·11 생략·1 실패**이며, 실패는 실물 시각 품질 검사입니다. 영어 25번 그래프 라벨 배치, 국어 1쪽 겹침, 장식 프레임과 긴 문단의 재흐름, 한컴 GUI 검증이 남았습니다. 과거 PNG 87.31과 현재 점수를 직접 비교하지 않으며, 배치 평균을 5분야 종합 점수로 해석하지 않습니다.
