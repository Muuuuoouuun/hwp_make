...
> 최신 실물 검증은 [한컴 GUI·가져오기 후속 검증](audits/2026-09-23/hancom-import-followup.md)을 따릅니다. 영어 HWPX는 한글 2024에서 문단 직접 수정·저장·재열기가 됐지만, 원본 PDF와 rhwp의 8쪽이 **한글에서는 10쪽**이었다. 따라서 한글 배치 일치는 실패다. HWPX 미주형 시험지 가져오기는 영어 45·수학 46·국어 45·지구과학 20개 문항과 정답·풀이 분리를 확인했다. 다만 수학·지구과학의 표 안 선택지는 별도 선택지 필드로 분리되지 않는다. 기존 [36쪽 엄격 평가](audits/2026-09-23/grid-frame-paragraphs-progress.md)의 평균 **87.06**, 최저 **72.85**와 **93점 미달**, **103 통과·11 생략·1 실패**는 그대로다. 영어 25번 그래프 라벨, 국어 1쪽 겹침, 프레임과 긴 문단의 재흐름도 남아 있다. 과거 PNG 87.31과 현재 점수를 직접 비교하지 않으며, 배치 평균을 5분야 종합 점수로 해석하지 않는다.

> 다른 과목 확장 결과는 [2026-09-21 21과목·168쪽 가혹 평가](audits/2026-09-21/subject-expansion.md)를 참고한다. 없는 12과목을 확보했으며 기본 검증 통과 13과목, 차단 8과목, 배치 98점·원본 쪽수 동시 충족 0과목이다. 실행 이후 공유 소스 변경과 적용 범위는 해당 보고서에 명시했다.

> 이전 평가는 [2026-09-21 문단·편집성 엄격 평가](audits/2026-09-21/strict-paragraph-assessment.md)에 보존한다. 아래 2026-08-18 점수와 결과는 과거 스냅샷이며, 현재 PDF 원본 복원의 출시 판정에 사용할 수 없다.
