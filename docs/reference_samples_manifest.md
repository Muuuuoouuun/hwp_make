...
## Public Editable HWPX Research (2026-09-21)

[My1ta's June 2026 collection](https://www.my1ta.com/blog/2026-june-mock-exam-hwpx-collection) links the public attachments below. These are one producer's editable versions, not a representative sample of every official exam format. Source binaries and their rendered pages remain local; do not redistribute them.

| Original filename | Source page | Local research filename | Purpose |
| --- | --- | --- | --- |
| `마이일타_2026년_고3_6월_영어.hwpx` | [English/social studies/history](https://blog.naver.com/my1ta/224306876900) | `web_english.hwpx` | Endnote numbering, passages and explanation ownership |
| `마이일타_2026년_고3_6월_수학.hwpx` | [Korean/math/science](https://blog.naver.com/my1ta/224306864261) | `web_math.hwpx` | Equations, tables, figures and endnote ownership |
| `마이일타_2026년_고3_6월_국어_화법과작문.hwpx` | [Korean/math/science](https://blog.naver.com/my1ta/224306864261) | `web_korean.hwpx` | Shared passages, question boundaries and endnotes |
| `마이일타_2026년_고3_6월_지구과학1.hwpx` | [Korean/math/science](https://blog.naver.com/my1ta/224306864261) | `web_earth_science.hwpx` | Dense equations/figures and endnote ownership |

- Local root: `data/research/20260921_hwp_exam/working/`.
- Download URLs, exact byte sizes and SHA-256 values: `data/research/20260921_hwp_exam/web_samples.json`.
- Findings and measured failures: [research report](audits/2026-09-21/exam_hwp_web_app_research.md).
- A copyright-independent reproduction is generated by `scripts/fixtures/create_endnote_exam_probe.py`; it uses three original arithmetic questions. GUI compatibility remains unverified.
