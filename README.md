...
- [최신 PDF→한글 개발·5분야 평가](docs/audits/2026-09-22/body-scope-baseline-progress.md): 본문·머리말 대조 오류와 첫 줄 수식의 기준선을 수정했습니다. 국어·수학·영어 36쪽 엄격 배치 평균은 **86.47 → 87.31**, 전체 회귀는 **101 통과·11 생략·1 실패**, 정상 패키지 33개 유효입니다. 본문 10줄을 한 문단으로 유지하며 790자 추가·재저장을 통과했습니다. **93점 미달입니다.** 6쪽의 점수 하락, 그래프 표기 중복·배치 오차, 원본 글꼴과 실제 한컴 GUI 편집 검증이 남았습니다.
